...
- [**Services**](android-components/service/a-service/Service.md) - Background work, Foreground services, and WorkManager.
...
- [**WorkManager**](android-components/service/workmanger/workmanager.md) - Background work, Foreground services, and WorkManager.
- [**App Witout An Activity ?**](android-components/service/serviceApp.md)
...
- [**Storage Methods**](Storage.md) - SharedPrefs, Room, and the Scoped Storage model.
...
- [**JNI & NDK**](JNI.md) - Native C++ bridging and Direct ByteBuffers.
- [**Code Obfuscation**](obfuscate/ProguardR8.md) - R8 internals, Mapping files, and Keep rules.
- [**WebView Security**](WebView.md) - JS Injection risks and modern fixes.
...
This guide is designed for developers who want to move beyond "building apps" and start understanding the **internal mechanics** of the Android OS. Every section includes **Interview-Ready Answers** to help you ace senior-level technical rounds.
